package com.example.diplomskibackend.config;
...
import com.example.diplomskibackend.security.auth.RestAuthenticationEntryPoint;
import com.example.diplomskibackend.security.auth.TokenAuthenticationFilter;
import com.example.diplomskibackend.service.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/announcements/mechanization").permitAll()
                .antMatchers("/api/product/**").permitAll()
                .antMatchers("/api/announcements/mechanization/subcategories").permitAll()
                .antMatchers("/api/announcements/mechanization/sort-by-price").permitAll()
                .antMatchers("/api/advertisement/**").permitAll()
                .antMatchers("/api/**").permitAll()
                .antMatchers("/upload").permitAll()
                .antMatchers("/users/signup/async").permitAll()
                .antMatchers("/users/signup/company").permitAll()
